...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'controller.app.admin_homepage' => 'getController_App_AdminHomepageService',
            'controller.app.homepage' => 'getController_App_HomepageService',
    ...
    /**
     * Gets the 'controller.app.admin_homepage' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\Admin A AppBundle\Controller\Admin instance.
     */
    protected function getController_App_AdminHomepageService()
    {
        return $this->services['controller.app.admin_homepage'] = new \AppBundle\Controller\Admin($this->get('templating'));
    }

    /**
     * Gets the 'controller.app.homepage' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\Homepage A AppBundle\Controller\Homepage instance.
     */
    protected function getController_App_HomepageService()
    {
        return $this->services['controller.app.homepage'] = new \AppBundle\Controller\Homepage($this->get('templating'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'my_project', 'user' => 'root', 'password' => 'password1', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7174ef510746caab2b4824d9130d2cdbb5060c332b68fc5d8785246d1ea9eaac');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('7337e902a48ff827d22b5587ac72c5c3198d41ce');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('561fb2344f8c70.44821287')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '7337e902a48ff827d22b5587ac72c5c3198d41ce',
            'locale' => 'en',
            ...
            'kernel.secret' => '7337e902a48ff827d22b5587ac72c5c3198d41ce',
